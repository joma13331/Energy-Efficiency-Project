...
from Prediction.EEDataLoaderPred import EEDataLoaderPred
from Prediction.EEEDAPred import EEPredEda
from Prediction.EEFeatureEngineeringPred import EEFeatureEngineeringPred
from Prediction.EEFeatureSelectionPred import EEFeatureSelectionPred
...
class EEPredictionPipeline:
    ...
    def ee_predict(self):
        try:
            ...
            message = "Start of Prediction Pipeline"
            ...
            message = f"Prediction data obtained"
            self.logger.log(log_file, message)
            ...
            message = "End of Prediction Pipeline"
            self.logger.log(log_file, message)
