...
from Training.EEDataLoaderTrain import EEDataLoaderTrain
from Training.EEEDATrain import EEEdaTrain
from Training.EEFeatureEngineeringTrain import EEFeatureEngineeringTrain
from Training.EEFeatureSelectionTrain import EEFeatureSelectionTrain
from Training.EEClusteringTrain import EEClusteringTrain
from Training.EEModelFinder import EEModelFinder
...
class EETrainingPipeline:
    ...
    def __init__(self):
        ...
        if not os.path.isdir("Models/Mlmodels/"):
            os.mkdir("Models/Mlmodels/")
        self.model_dir = "Models/Mlmodels/"

        if not os.path.isdir("Models/Clustering/"):
            os.mkdir("Models/Clustering/")
        self.cluster_dir = "Models/Clustering/"

    def ee_model_train(self):

        try:
            log_file = open(self.log_path, 'a+')
            message = "Start of Training Pipeline"
            ...
            for j in range(len(features)):
                ...
                file_operator.ee_save_model(scalar, "Models/", "scalar.pickle")
