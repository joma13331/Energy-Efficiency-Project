import pandas as pd
import threading
from EEPrediction.EEDataFormatPred import EEDataFormatPred
from EEPrediction.EEDBOperationPred import EEDBOperationPred
from EEPrediction.EEBeforeUploadPred import EEBeforeUploadPred
...
class EEDataInjestionCompPred:
    ...
    def __init__(self, path="EEPredDatasets/"):
    ...
    def ee_data_injestion_complete(self):
        ...
        try:
            ...
            message = "Raw EEPrediction Data Validation complete"
            self.logger.log(log_file, message)
            ...
            message = "Start of upload of the Good EEPrediction Data to Cassandra Database"
            self.logger.log(log_file, message)
            ...
            message = "End of upload of the Good EEPrediction Data to Cassandra Database"
            self.logger.log(log_file, message)
