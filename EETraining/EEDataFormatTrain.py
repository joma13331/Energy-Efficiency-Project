...
class EEDataFormatTrain:
    ...
    Description: This class shall be used for handling all the validation done on the Raw EETraining Data
    ...
    def __init__(self, path):
        ...
        """
        self.dir_path = path
        self.good_raw_path = "EEDIV/ValidatedData/GoodRaw/"
        self.bad_raw_path = "EEDIV/ValidatedData/BadRaw/"
        self.schema_path = "EESchema/training_schema.json"
    ...
    def ee_move_bad_files_to_archive(self):
        ...
        try:
            ...
            if os.path.isdir(self.bad_raw_path):
                archive_dir = "EEDIV/ArchivedData"
